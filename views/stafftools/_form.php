...
<div class="senditem-_form">
    ...
    <?php $form = ActiveForm::begin(); ?>
        ...
        <?=$form->field($model, 'id_unit_sender')->textInput(['class'=>'setlist']);  ?>
        </div><div class="col-md-6">
        <?= $form->field($model, 'name_receiver') ?>
        </div><div class="col-md-6">
        <?= $form->field($model, 'id_reg_type')->textInput(['class'=>'setreglist']); ?>
        </div>
        ...
        <?= $form->field($model, 'id_reg_item')->textInput(['class'=>'form-control']); ?>
        </div>
